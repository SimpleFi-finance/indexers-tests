...
import { Account, Market, Pair, Transaction, Mint as MintEvent, Burn as BurnEvent } from '../../generated/schema'
...
export function handleSync(event: Sync): void {
  let pair = Pair.load(event.address.toHexString()) as Pair
  createPairSnapshot(pair, event)
  // sync() exists to set the reserves of the contract to the current balances
