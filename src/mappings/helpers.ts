...
export function createPosition(
  ...
  let positionId = accountPosition.id.concat('-').concat(accountPosition.positionCounter.toString())
...
export function createPositionSnapshot(position: Position, transaction: Transaction): void {
  let id = position.id.concat('-').concat(position.historyCounter.toString())
