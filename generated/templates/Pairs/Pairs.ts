...
export class Pairs__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pairs__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Pairs extends ethereum.SmartContract {
  static bind(address: Address): Pairs {
    return new Pairs("Pairs", address);
  }
  ...
  burn(to: Address): Pairs__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new Pairs__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<Pairs__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Pairs__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): Pairs__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new Pairs__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<Pairs__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
